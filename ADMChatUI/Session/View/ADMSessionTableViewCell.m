...
@implementation ADMSessionTableViewCell {
...
- (void)setConfig:(ADMChatSessionModel *)model {
    ...
    _notiImageView.image = [ADMInputHelper otherImageNamed:@"ADM_chat_bell_not"];
    _nameLabel.text = model.name;
    _messageLabel.text = lastMsg;
    _timeLabel.text = [ADMChatHelper timeFromTimeStamp:[NSString stringWithFormat:@"%@",@(lastTimestamp)]];
