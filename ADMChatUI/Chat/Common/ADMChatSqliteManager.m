...
@interface ADMChatSqliteManager () {
...
@implementation ADMChatSqliteManager
...
+ (instancetype)defaultManager{
    ...
    static ADMChatSqliteManager *manager;
    dispatch_once(&onceToken, ^{
        manager = [[ADMChatSqliteManager alloc] init];
    });
    return manager;
}
...
- (NSArray *)allPropertyNameInClass:(Class)cls{
    if ([cls isSubclassOfClass:[ADMChatBaseModel class]]) {
...
- (NSDictionary *)DictionaryFromModel:(id)model{
    if ([model isKindOfClass:[ADMChatBaseModel class]]) {
