...
@implementation ADMChatVoiceMessageCell {
...
- (void)setConfig:(ADMChatMessageModel *)model isShowName:(BOOL)isShowName {
    ...
    if (model.isSender) {
        ...
        _voiceImageView.image = [ADMInputHelper otherImageNamed:@"ADM_chat_voice_2"];
        ...
        _voiceImageView.image = [ADMInputHelper otherImageNamed:@"ADM_chat_voice_1"];
