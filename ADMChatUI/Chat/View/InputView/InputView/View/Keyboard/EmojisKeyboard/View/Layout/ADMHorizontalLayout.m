...
@implementation ADMHorizontalLayout
...
- (id)initWithSpacing:(CGFloat)spacing rows:(NSInteger)rows nums:(NSInteger)nums {
    ...
    if (self) {
        ...
        _ADMItemSize = CGSizeMake(itemWidth, itemHeight);
    }
    return self;
}
...
- (void)prepareLayout{
    ...
    CGFloat itemWidth = _ADMItemSize.width;
    CGFloat itemHeight = _ADMItemSize.height;
