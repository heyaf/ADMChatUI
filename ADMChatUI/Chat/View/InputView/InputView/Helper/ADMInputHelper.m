...
+ (instancetype)helper {
    static ADMInputHelper *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[ADMInputHelper alloc] init];
    });
    return instance;
}
...
+ (UIImage *)otherImageNamed:(NSString *)name {
    ...
    ADMInputHelper *helper = [ADMInputHelper helper];
...
- (NSString *)lxhPath {
    if (_lxhPath == nil) {
        NSString *emoticon = [[NSBundle mainBundle] pathForResource:@"ADMEmoticon" ofType:@"bundle"];
